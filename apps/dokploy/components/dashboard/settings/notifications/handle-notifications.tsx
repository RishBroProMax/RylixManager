							...
							<div className="grid md:grid-cols-2 gap-4">
								...
								<FormField
									...
									render={({ field }) => (
										<FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-xs gap-2">
											<div className="space-y-0.5">
												<FormLabel>RylixManager Backup</FormLabel>
												<FormDescription>
													Trigger the action when a RylixManager backup is created.
												</FormDescription>
											</div>
											<FormControl>
												<Switch
								...
								{!isCloud && (
									<FormField
										...
										render={({ field }) => (
											<FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-xs gap-2">
												<div className="space-y-0.5">
													<FormLabel>RylixManager Restart</FormLabel>
													<FormDescription>
														Trigger the action when RylixManager is restarted.
													</FormDescription>
												</div>
												<FormControl>
													<Switch
