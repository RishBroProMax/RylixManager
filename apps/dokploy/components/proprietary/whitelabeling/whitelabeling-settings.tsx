...
const DEFAULT_CSS_TEMPLATE = `/* ============================================
   RylixManager Default Theme - CSS Variables
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input placeholder="RylixManager" {...field} />
										</FormControl>
										<FormDescription>
											Replaces "RylixManager" across the entire interface.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input
												placeholder="Modern VPS & Container Management Platform for Developers."
												{...field}
											/>
										</FormControl>
										<FormDescription>
											Tagline shown on the login/onboarding pages. Defaults to
											the standard RylixManager description if empty.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>
											Browser tab title. Defaults to "RylixManager" if empty.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
