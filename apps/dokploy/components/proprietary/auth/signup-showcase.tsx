	...
	[
		{
			...
			description:
				"Manage and back up MySQL, PostgreSQL, MongoDB, MariaDB, and Redis directly from RylixManager.",
		},
		{
			icon: Terminal,
			title: "API & CLI",
		...
		},
		{
			...
			title: "No lock-in",
			description:
				"Modify, scale, and customize RylixManager however your project needs.",
		},
	],
];
