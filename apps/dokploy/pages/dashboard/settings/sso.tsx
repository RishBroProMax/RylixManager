					...
					<div className="rounded-xl bg-background shadow-md">
						<EnterpriseFeatureGate
							lockedProps={{
								...
								description:
									"Single sign-on (SSO) with OIDC and SAML is part of RylixManager Enterprise. Add a valid license to configure it.",
					...
					<div className="rounded-xl bg-background shadow-md">
						<EnterpriseFeatureGate
							lockedProps={{
								...
								description:
									"Protect deployed applications behind an OIDC SSO gate (oauth2-proxy). Part of RylixManager Enterprise.",
								ctaLabel: "Go to License",
							}}
						>
							<ForwardAuthServers />
						...
						<div className="rounded-xl bg-background shadow-md">
							<EnterpriseFeatureGate
								lockedProps={{
									...
									description:
										"Deployment and authentication restrictions are part of RylixManager Enterprise. Add a valid license to configure them.",
									ctaLabel: "Go to License",
								}}
							>
								<CardHeader>
